...
if __name__ == "__main__":
   ...
   # pyhonImage = gif(data_array_subset, to="temperature_animation.gif")
    ...
    # how to download this dataset and save to current folder


    # new data 
    #file_path_hpx = '/home/adboer/dlwp-hpx/src/dlwp-hpx/data/era5_1deg_1D_HPX32_1940-2024_sst.nc'
    ...
    # file_path_hpx = '/home/adboer/dlwp-hpx/src/dlwp-hpx/data/era5_1deg_1D_HPX32_1940-2024_t2m.nc'

    # dataset = xr.open_dataset(file_path_hpx)
    # file_path_ll = "/home/adboer/dlwp-hpx/src/dlwp-hpx/data/era5_checkconv.nc"
    # print("projecting forecast file generated by DLWP-HPX from HEALPix to LatLon")
    # dataset = dataset.rename({'sample': 'time'})
