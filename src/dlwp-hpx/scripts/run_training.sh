...
# era5_1deg_3h_HPX32_1979-2018_z500.nc  python -u scripts/train.py model=hpx_rec_unet  experiment_name=testing_today data.prefix= era5_1deg_3h_HPX32_1979-2018_ data=era5_hpx32_6var_6h_24h
