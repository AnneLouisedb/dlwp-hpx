...
# Internal modules
from .data_loading import CustomBatch, \
                          create_time_series_dataset_classic, open_time_series_dataset_classic_prebuilt, \
                          open_time_series_dataset_classic_on_the_fly, create_time_series_dataset_zarr, \
                          open_time_series_dataset_zarr, \
                          TimeSeriesDataset
...
class TimeSeriesDataModule():
    ...
    def __init__(
        ...
        # here we can switch between two differen modes:
        self.dataset_batch_size = self.batch_size
        self.dataloader_batch_size = None
        self.collate_fn = None
        #self.dataset_batch_size = 1
        #self.dataloader_batch_size = self.batch_size
        #self.collate_fn = self._batch_collate
